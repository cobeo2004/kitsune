...
![Kitsune distributed search architecture](../prd/assets/distribuited_search_engine_architecture_diagram.png)
...
- [Architecture](architecture.md) explains the process topology, request flows, and state boundaries.
- [Usage](usage.md) shows local development, API calls, smoke tests, and docs-site commands.
- [Components](components.md) maps the Go packages and runtime services.
- [Technical Decisions](technical-decisions.md) records the durable design decisions.
- [Roadmap](roadmap.md) links the implemented milestones to the remaining product direction.

## Source Artifacts

The Starlight docs are the publishable human-facing documentation. The planning source remains in the repository:

- PRD: `../prd/prd-kitsune-distributed-search-engine.md`
- Roadmaps: `../roadmaps`
- Specs: `../superpowers/specs`
- Plans: `../superpowers/plans`
- Local operations notes: `../operations/local-cluster.md`
