...
The implementation follows the PRD in `docs/prd/prd-kitsune-distributed-search-engine.md` and the milestone roadmap in `docs/roadmaps/index.md`.
...
- a roadmap entry in `docs/roadmaps`
- a design spec in `docs/superpowers/specs`
- an execution plan in `docs/superpowers/plans`
